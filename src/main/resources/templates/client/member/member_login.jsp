...
<script>
	// JavaScript를 사용하여 RESTful 엔드포인트 호출 후 데이터 표시
	fetch('/client/member/member_login.do')
		.then(response => response.json())  // '=' 대신 '=>' 사용
		.then(data => {
			document.getElementById('dataContainer').innerText = 'Data from API: ' + data.someProperty;
		});
</script>
