			...
			<div class="flex-container">
				<div class="flex-row">
					...
					<div class="flex-content">
						<input type="password" tabindex="3" name="now_pw"
				...
				<div class="flex-row">
					<div class="flex-header">비밀번호 확인</div>
					<div class="flex-content">
						<input type="password" tabindex="4"
							placeholder="비밀번호를 정확하게 입력해 주세요." name="mer_pw2" class="box"
							placeholder="Enter passwordCheck" id="passwordCheck">
					</div>
				</div>
