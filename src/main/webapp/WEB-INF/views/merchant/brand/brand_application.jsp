...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/merchant/css/brandInformStyle.css">
...
<body style="background-color: #F4F4F4">
	<div class="centered-form-container">
		<div class="con">
			<h2>입점신청</h2>
			<h4>
				• 입점신청중에는 중복 신청이 불가하고, 입점 거절 또는 취소시 재입점 신청은 <span
					class="notice-link">OZ의 집 공지사항</span> 을 확인하여 주시기 바랍니다.<br> •
				공지사항 외의 궁금한 사항은 OZ의 집 판매자센터로 연락하시면 친절히 안내해드리겠습니다.<br> • 입점신청중에는
				중복 신청이 불가하고, 입점 거절 또는 취소시 재입점 신청은 <span class="red-text">3개월
					후</span>에 가능합니다.<br> <br>
				<hr>
			</h4>
			<h3>사업자 인증</h3>
			<form name="f"
				action="${pageContext.request.contextPath}/api/brands/application"
