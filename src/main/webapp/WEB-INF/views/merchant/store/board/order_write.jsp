...
<div class="container">
	...
	<form name="f" action="order_reqa.do?order_QA_num=${order_QA_num }"
		method="post" onsubmit="return validateForm()">
		<input type="hidden" name="order_reQA_num" value="${order_QA_num}">
		<input type="hidden" name="mer_num" value="${mer_num}"> <input
		...
		<div class="content-container">
			...
			<div class="flex-container">
				...
				<div class="button-group">
					<input type="submit" value="답변 작성"> <input type="reset"
