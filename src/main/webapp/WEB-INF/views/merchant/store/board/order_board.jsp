...
<div class="container">
	<div class="content-container">
		...
		<div class="flex-container">
			<form name="f1" action="board_orderBoard.do?mer_num=${mer_num }" class="flex-container">
		...
		<div class="scroll flex-container content-table">
			...
			<c:forEach var="dto" items="${orderQAList}">
				<div class="flex-row">
					...
					<div class="flex-cell">
						<c:if test="${dto.order_QA_state == 'f'}">
						            <input type="button" class="update-button" style="background-color: #50E5B4; color: white;" value="답변" onclick="window.location='order_reqa.do?order_QA_num=${dto.order_QA_num}'">
						<!--         
		                    <a href="javascript:answerQuestion(${dto.order_QA_num});">답변</a>
		                     -->
						</c:if>
						<c:if test="${dto.order_QA_state == 't'}">
						            <input type="button" class="update-button" style="background-color: #50E5B4; color: white;" value="수정" onclick="window.location='order_reqa_update.do?order_reQA_num=${dto.order_QA_num}'">
						<!-- 
