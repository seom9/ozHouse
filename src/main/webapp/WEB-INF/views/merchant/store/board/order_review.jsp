...
<div class="container">
	<div class="content-container">
		...
		<div class="flex-container">
			...
			<form name="f1" action="${pageContext.request.contextPath}/merchants/${merchantLoginMember.merNum}/reviews"
						...
						<select name="review_star" id="review_star">
							<c:forEach var="star" begin="0" end="5">
								<option id="star" value="${star}"
									${param.review_star == star ? 'selected' : ''}>${star}</option>
							</c:forEach>
						</select>
					</div>
				</div>
					...
					<div class="flex-cell input-cell">
						<select id="search" name="search">
							...
							<option value="review_content"
								${param.search == 'review_content' ? 'selected' : ''}>내용</option>
		...
		<div class="scroll flex-container content-table">
			...
			<c:forEach var="dto" items="${reviewList}">
				<div class="flex-row">
					...
					<div class="flex-cell">
						<a href="review_content.do?review_num=${dto.review_num }"> <c:choose>
