...
<div class="container">
	<div class="content-container">
		...
		<c:set var="mer_num" value="${merchantLoginMember.mer_num}"/>
			<form name="f1" action="board_productBoard.do?mer_num=${mer_num }" class="flex-container">
	       ...
	       <div class="flex-row header-row">
		    ...
		    <c:forEach var="dto" items="${productQAList}">
		        <div class="flex-row">
		            ...
		            <div class="flex-cell">
		                <c:if test="${dto.product_QA_state == 'f'}">
          					<input type="button" class="update-button" style="background-color: #50E5B4; color: white;" value="답변" onclick="window.location='product_reqa.do?product_QA_num=${dto.product_QA_num}'">
		                  <!-- 
		                    <a href="javascript:answerQuestion(${dto.product_QA_num});">답변</a>
		                   -->  
		                </c:if>
		                <c:if test="${dto.product_QA_state == 't'}">
		                <input type="button" class="update-button" style="background-color: #50E5B4; color: white;" value="수정" onclick="window.location='product_reqa_update.do?product_reQA_num=${dto.product_QA_num}'">
