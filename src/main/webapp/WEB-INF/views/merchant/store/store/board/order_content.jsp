...
<div class="container">
	<div class="content-container">
				...
				<div class="flex-container">
					<c:forEach var="redto" items="${orderReContent}">
						<form name="f2" action="javascript:requestQuestion(${redto.order_reQA_num});" method="post">
							<div class="flex-row">
								<div class="flex-cell">작성일</div>
								<div class="flex-cell">${redto.order_reQA_date}</div>
							</div>
							<div class="flex-row">
								<div class="flex-cell">글내용</div>
		...
		<div class="flex-row">
			<div class="flex-cell">
				<input type="button" value="목록 보기" onclick="window.location='board_orderBoard.do?mer_num=${merchantLoginMember.mer_num}'">
			</div>
		</div>
	</div>
</div>
