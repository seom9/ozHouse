...
<div class="container">
	...
	<form name="f" action="order_reqa_update.do" method="post" onsubmit="return validateForm()">
		<div class="content-container">
			...
			<c:forEach var="redto" items="${orderReContent}">
				...
				<div class="flex-container">
					<div class="flex-row">
						...
						<div class="flex-cell-sub"><textarea name="order_reQA_content" rows="11" cols="40" class="box">${redto.order_reQA_content}</textarea></div>
					</div>
					<div class="flex-row">
						<div class="flex-cell">
							<input type="submit" value="글수정">
							<input type="reset" value="다시작성">
							<input type="button" value="목록보기" onclick="window.location='board_orderBoard.do?mer_num=${merchantLoginMember.mer_num}'">
						</div>
					</div>
				</div>
			</c:forEach>
