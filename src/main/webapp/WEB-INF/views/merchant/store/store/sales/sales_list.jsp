    ...
    <div class="content-container">
        <h1 class="sales-header">
	 	...
	 	<div class="flex-container">
			...
			<form name="f" action="sales_list.do?mer_num=${merchantLoginMember.mer_num}" class="flex-container" method="post"><!-- 로그인 연결하면 mer_num 수정하기 -->
				<div class="flex-row">
						...
						<c:forEach var="dto" items="${salesList}">
							...
							<div class="flex-row">
			                	<div class="flex-cell">${dto.order_code}
			               			<div class="sub-content">${dto.member_id}</div>
			                	</div>
	                			<div class="flex-cell">${dto.order_date}
					               	...
					               	<c:if test="${dto.order_canceldate ne '0'}">
					                   	<div class="sub-content">${dto.order_canceldate}</div>
					                </c:if>
	               				</div>
				                <div class="flex-cell">
