...
<div class="container">
	...
	<form name="f" action="product_reqa_update.do" method="post" onsubmit="return validateForm()">
		<div class="content-container">
			...
			<c:forEach var="redto" items="${productReContent}">
				...
				<div class="flex-container">
					<div class="flex-row">
						...
						<div class="flex-cell-sub"><textarea name="product_reQA_content" rows="11" cols="40" class="box">${redto.product_reQA_content}</textarea></div>
					</div>
					<div class="flex-row">
						<div class="flex-cell">
							<input type="submit" value="글수정">
							<input type="reset" value="다시작성">
							<input type="button" value="목록보기" onclick="window.location='board_productBoard.do?mer_num=${merchantLoginMember.mer_num}'">
						</div>
					</div>
				</div>
			</c:forEach>
