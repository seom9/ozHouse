...
function fetchAndDisplayMsg(productNum) {
    $.ajax({
        url: 'getProductMessage.do', // Endpoint in the controller
        type: 'GET',
    ...
    <img src="${product_image}/${dto.product_image_change}" width="40" height="40">
				...
				<div class="flex-cell">
					...
					<div class="flex-cell">
						...
						<a href="product_update.do?product_num=${dto.product_num}&mer_num=${merchantLoginMember.mer_num}">수정</a> |
						<a href="product_delete.do?product_num=${dto.product_num}&mer_num=${merchantLoginMember.mer_num}">삭제</a>
					</div>
				</c:if>
<c:if test="${dto.product_approval_status=='ca'}">
    ...
    <div class="flex-cell">
	    ...
	    <input type="button" value="Delete Selected" onclick="deleteSelectedProducts()">
</form>
</div>
