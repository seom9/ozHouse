...
<link rel="stylesheet" href="${path}/merchant/login.css" />
<link rel="stylesheet" type="text/css"
	href="${path}/merchant/css/styleMain.css">
<link rel="stylesheet" type="text/css"
	href="${path}/merchant/css/find_style.css">
<title>이메일 인증</title>
...
<body>
	...
	<div class="container">
		...
		<form name="f" method="post" id="login-form"
			action="${pageContext.request.contextPath}/merchant/login/join/email-verification">
