    ...
    <div class="container">
        <div class="content-container">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="price-inputs">
                            <div>
                                대표가 :
                                <fmt:formatNumber value="${getProduct.proPrice}" pattern="###,###" />원
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <c:forEach var="encodedImagePro" items="${encodedImagesPro}">
                                <img src="data:image/png;base64,${encodedImagePro}" width="800" height="800">
                            </c:forEach>
                        </div>
                    </div>
                </div>
            ...
            <div class="button-container">
                <input type="button" class="list-button" value="목록보기" onclick="window.location='${pageContext.request.contextPath}/ozMarket'">
            </div>
        </div>
    </div>
</body>
