...
public class MerReturnServiceImpl implements MerReturnService {
	private final OrderTbRepository orderRepository;
	
	private List<ReturnDTO> setListDto(List<OrderTb> ot){
		List<ReturnDTO> listDto = new ArrayList<>();
		for(OrderTb o : ot) {
...
//					.order_delivery_now(o.getODelnow())
	...
	public List<ReturnDTO> returnList(int merNum) {
		...
		//List<ReturnDTO> listDto = setListDto(ot);
		return null;
	}
